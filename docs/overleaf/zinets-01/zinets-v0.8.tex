...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{./images/fibonacci-spiral.png}}
...
\item
  ...
  \begin{figure}
  \centering
  \pandocbounded{\includegraphics[keepaspectratio]{./images/sun-moon-heaven-human-earth-meditation-morning.jpg}}
...
\item
  ...
  \begin{figure}
  \centering
  \pandocbounded{\includegraphics[keepaspectratio]{./images/part-frequency-top-25.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{./images/zi_sun.png}}
\caption{zi\_sun}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{./images/zi_join.png}}
\caption{zi\_join}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{./images/zi_work.png}}
\caption{zi\_work}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{./images/app_zinets.png}}
\caption{ZiNets}
\end{figure}

\paragraph{Chinese Character Network
Patterns}\label{chinese-character-network-patterns}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{./images/app_decomposing-zi.png}}
\caption{ZiNets}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{./images/app_zi-parts-1.png}}
\caption{Decomposition-1}
\end{figure}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{./images/app_zi-parts-2.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{./images/app_zi-elements.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{./images/app_discover-zi-by-part.png}}
\caption{Search}
\end{figure}
